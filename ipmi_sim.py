...
install_data_dir = [
    os.path.join(os.environ['HOME'], '.ipmicons'),
    os.path.join(sys.prefix, 'ipmicons'),
    os.path.join(sys.prefix, 'share', 'ipmicons'),
    os.path.join(os.path.split(__file__)[0], 'ipmicons'),
...
from ipmicons import sdr
from ipmicons import common
from ipmicons import sshsrv
